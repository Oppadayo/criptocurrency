...
const CryptoDetail = ({ route, navigation }) => {
                ...
                >
                    {numberOfCharts.map((item, index) => {
                        ...
                        const dotSize = dotPosition.interpolate({
                            inputRange: [index - 1, index, index + 1],
                            outputRange: [SIZES.base * 0.5, 8, SIZES.base * 0.5],
                            extrapolate: 'clamp'
                        })
                ...
                >
                    ...
                    >
                        ...
                        <View>
                            ...
                            <Text style={{color: selectedCurrency?.type == 'B' ? COLORS.red : COLORS.green, ...FONTS.body3}}>{selectedCurrency?.changes}</Text>
                        </View>
                    </View>
                        ...
                        {chartOptions.map((option)=>{
                            return(
                                <TextButton 
                                    ...
                                    customLabelStyle={{
                                        color: selectedOptions.id == option.id ? COLORS.white : COLORS.gray, ...FONTS.body5
                                    }}
            ...
            >
                <View style={{
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                        ...
                        <Text style={{textAlign: 'right', color: COLORS.gray}}>{selectedCurrency?.wallet.crypto} {selectedCurrency?.code}</Text>
                        </View>
    ...
    return (
        ...
        >
            ...
            <ScrollView>
                <View style={{felx: 1, paddingBottom: SIZES.padding}}>
                    {renderChart()}
                    {renderBuy()}
                    {renderAbout()}
                    <PriceAlert 
